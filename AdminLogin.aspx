...
<head>
    ...
    <title>Admin Login - Patient Bridge</title>
    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-center">
            <div class="card ">
                ...
                <div class="card-body">
                    <form class="needs-validation" runat="server" ID="form1"  >
                        ...
                        <div class="input-group form-group">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Email ID is Required!" ControlToValidate="TextBox1" ForeColor="Red" ></asp:RequiredFieldValidator>
                        </div>
                        <div class="input-group form-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class='fa fa-key ml-2' style='font-size: 22px; color:white;'></i></span>
                                <asp:TextBox ID="TextBox2" class="form-control" TextMode="Password" placeholder="Enter Password"  runat="server"></asp:TextBox>
                            </div>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" SetFocusOnError="true" runat="server" ErrorMessage="Password is Required!" ControlToValidate="TextBox2" ForeColor="Red" ></asp:RequiredFieldValidator>
                        </div>
                        <div class="form-group">
                            <a href="Default.aspx" class="btn btn-default" > <i class="fas fa-backward"></i> Go Back to Website</a>
                            <asp:Button ID="Button1" runat="server" Text="Login" CssClass="btn float-right login_btn text-light" OnClick="Button1_Click" />
                        </div>
